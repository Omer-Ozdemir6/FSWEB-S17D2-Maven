...
public class DeveloperController {
    ...
    public void init(){
        ...
        this.developers.put(1, new SeniorDeveloper(1,"John", 2000d));
    }
    ...
    public DeveloperResponse save(@RequestBody Developer developer){
        ...
        if(Objects.nonNull(createDeveloper)){
            developers.put(createDeveloper.getId(),createDeveloper);
        }
        return new DeveloperResponse(createDeveloper, HttpStatus.CREATED.value(), "create işlemi başarılı");
    }
